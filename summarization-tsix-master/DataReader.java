...
//javac -cp ".:/Users/hobingxuan/Downloads/summarization-tsix-master/t4j.jar" DataReader.java
// java -cp ".:/Users/hobingxuan/Downloads/summarization-tsix-master/a.jar" DataReader
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException{
		...
		for (int i = 0; i<files.length; i++){
			...
			if (lang.equals("en")){
				...
				String numFavourite = "" + status.getFavoriteCount();
				String numRetweet = "" + status.getRetweetCount();
				String userId = "" + status.getUser().getId();
				String statusId = "" + status.getId();
				String inReplyStatusId = "" + status.getInReplyToStatusId();
				String out = statusId + "|||" + inReplyStatusId + "|||"+userId + "|||"+numRetweet + "|||"+numFavourite + "|||"+s + "\t";
				fr.write(out);
				count ++;
			}
